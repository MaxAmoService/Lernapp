...
export const projektmanagementQuizQuestions = [
  {
    question: "Was beschreibt das Magische Dreieck?",
    type: "multiple" as const,
    options: [
      "Qualität, Budget und Zeit im Spannungsfeld",
      "Drei Projektphasen",
      "Drei Stakeholder-Gruppen",
      "Drei Testverfahren",
    ],
    correct: 0,
    explanation: "Das Magische Dreieck beschreibt Qualität, Budget und Zeit als Spannungsfeld. Wenn ein Punkt schwächelt, muss ein anderer ausgleichen.",
  },
  {
    ...
    options: [
      ...
      "Strukturiert, Modular, Automatisiert, Redundant, Transparent",
      "Sicher, Minimal, Adaptiv, Resilient, Technisch",
    ],
    correct: 0,
    explanation: "SMART = Spezifisch, Messbar, Anspruchsvoll/Akzeptiert, Realistisch, Terminiert. Hilft bei der korrekten Zielformulierung.",
  },
  {
    ...
    correct: 0,
    explanation: "Das Lastenheft wird vom Auftraggeber geschrieben und beschreibt WAS gemacht werden soll. Das Pflichtenheft kommt vom Auftragnehmer und beschreibt WIE.",
  },
  {
    question: "Was sind die 5 Phasen der DIN 69901?",
    type: "multiple" as const,
    options: [
      "Initiierung, Definition, Planung, Steuerung, Abschluss",
      "Planung, Design, Implementierung, Test, Wartung",
      "Analyse, Design, Entwicklung, Test, Deployment",
      "Konzept, Umsetzung, Prüfung, Freigabe, Wartung",
    ],
    correct: 0,
    explanation: "Die DIN 69901 definiert 5 Phasen: Initiierung, Definition, Planung, Steuerung und Abschluss.",
  },
  {
    question: "Was ist der Product Owner in Scrum?",
    type: "multiple" as const,
    options: [
      "Verbindung zum Kunden, pflegt das Backlog",
      "Leitet das Entwicklungsteam",
      "Verantwortlich für die technische Architektur",
      "Durchführung der Daily Standups",
    ],
    correct: 0,
    explanation: "Der Product Owner ist die Verbindung zum Kunden, pflegt das Product Backlog und setzt Prioritäten. Der Scrum Master ist Berater, nicht Teamleiter.",
  },
  {
    ...
    correct: 0,
    explanation: "Die EVA misst Projektfortschritt, Kostenentwicklung und Termintreue durch Vergleich von geplanten (PV), tatsächlich erbrachten (EV) und tatsächlichen Kosten (AC).",
  },
  {
    question: "Was zeigt ein Ishikawa-Diagramm?",
    type: "multiple" as const,
    options: [
      "Ursachen für ein Problem (Ursache-Wirkung)",
      "Den Projektzeitplan",
      "Die Teamstruktur",
      "Die Kostenentwicklung",
    ],
    correct: 0,
    explanation: "Das Ishikawa-Diagramm (Fischgräten-Diagramm) visualisiert die Ursachen für ein Problem, kategorisiert nach 6M: Mensch, Maschine, Material, Methode, Messung, Milieu.",
  },
  {
    question: "Was sind die 4 Werte des Agilen Manifests?",
    type: "multiple" as const,
    options: [
      "Individuen > Prozesse, Software > Dokumentation, Zusammenarbeit > Verträge, Reagieren > Befolgen",
      "Planung, Design, Test, Deployment",
      "Zeit, Budget, Qualität, Umfang",
      "Analyse, Design, Code, Review",
    ],
    correct: 0,
    explanation: "Die 4 Werte: 1) Individuen > Prozesse, 2) Funktionierende Software > Dokumentation, 3) Zusammenarbeit > Verträge, 4) Reagieren auf Veränderung > Befolgen eines Plans.",
  },
  {
    question: "Was ist ein Sprint in Scrum?",
    type: "multiple" as const,
    options: [
      "Ein Zeitraum von 2-4 Wochen mit einem festen Ziel",
      "Ein Meeting mit dem Kunden",
      "Eine Code-Review-Session",
      "Ein Deployment-Prozess",
    ],
    correct: 0,
    explanation: "Ein Sprint ist ein fixer Zeitraum (2-4 Wochen), in dem das Team ein fertiges Inkrement entwickelt. Am Ende steht ein funktionierendes Produkt.",
  },
  {
    question: "Was ist der Unterschied zwischen klassischem und agilem PM?",
    type: "multiple" as const,
    options: [
      "Klassisch = phasenbasiert, Agil = iterativ",
      "Klassisch = nur für kleine Projekte, Agil = nur für große",
      "Klassisch = ohne Dokumentation, Agil = mit Dokumentation",
      "Es gibt keinen Unterschied",
    ],
    correct: 0,
    explanation: "Klassisch ist phasenbasiert mit festen Anforderungen (Wasserfall). Agil ist iterativ mit sich ändernden Anforderungen (Scrum). Beide haben ihre Daseinsberechtigung.",
  },
];

export const projektmanagementCategories = [
  {
    id: "projektmanagement",
    name: "Projektmanagement",
    icon: "📋",
    description: "Klassisch & Agil, Scrum, DIN 69901, Magisches Dreieck, EVA, SMART",
  },
];
