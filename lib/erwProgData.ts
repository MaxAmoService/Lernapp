...
export const erwProgQuizQuestions = [
  {
    question: "Was besagt das Single Responsibility Principle (SRP)?",
    type: "multiple" as const,
    options: [
      "Eine Klasse sollte nur eine Aufgabe haben",
      "Eine Klasse sollte viele Aufgaben haben",
      "Eine Klasse sollte keine Methoden haben",
      "Eine Klasse sollte maximal 10 Zeilen haben",
    ],
    correct: 0,
    explanation: "SRP besagt, dass eine Klasse nur eine Verantwortung haben sollte. Das verbessert Wartbarkeit und Testbarkeit.",
  },
  {
    question: "Was ist der Vorteil von Interfaces?",
    type: "multiple" as const,
    options: [
      "Austauschbarkeit, Testbarkeit, klare Struktur",
      "Schnellerer Code",
      "Weniger Speicherverbrauch",
      "Schönere Benutzeroberfläche",
    ],
    correct: 0,
    explanation: "Interfaces ermöglichen Austauschbarkeit (verschiedene Implementierungen), Testbarkeit (Mocks) und klare Struktur (Verträge).",
  },
  {
    question: "Was ist ein Mock-Objekt?",
    type: "multiple" as const,
    options: [
      "Ein Test-Double, das eine echte Abhängigkeit ersetzt",
      "Ein fehlerhafter Code",
      "Ein Design Pattern",
      "Eine Datenbank",
    ],
    correct: 0,
    explanation: "Mocks ersetzen echte Abhängigkeiten im Test — z.B. eine Mock-Datenbank statt echter DB. Das macht Tests schnell und unabhängig.",
  },
  {
  ...
  },
  {
    ...
    type: "multiple" as const,
    options: [
      "Coupling = Abhängigkeit zwischen Klassen, Cohesion = Zusammengehörigkeit innerhalb",
      "Coupling = Code-Länge, Cohesion = Code-Farbe",
      "Coupling = Testabdeckung, Cohesion = Performance",
      "Es gibt keinen Unterschied",
    ],
    correct: 0,
    explanation: "Coupling (Kopplung) = Abhängigkeit zwischen Klassen (niedrig = gut). Cohesion (Kohäsion) = Zusammengehörigkeit innerhalb einer Klasse (hoch = gut).",
  },
  {
    question: "Was ist das AAA-Pattern bei Unit-Tests?",
    type: "multiple" as const,
    options: [
      "Arrange, Act, Assert — Vorbereiten, Ausführen, Prüfen",
      "Always Assert Anything — Immer prüfen",
      "Ask, Answer, Analyze — Fragen, Antworten, Analysieren",
      "Add, Append, Apply — Hinzufügen, Anwenden",
    ],
    correct: 0,
    explanation: "AAA = Arrange (Vorbereitung), Act (Aktion), Assert (Prüfung). Jeder Unit-Test folgt diesem Schema.",
  },
  {
    question: "Was besagt das Open/Closed Principle?",
    type: "multiple" as const,
    options: [
      "Offen für Erweiterung, geschlossen für Änderung",
      "Offen für alle, geschlossen für niemanden",
      "Offen für Tests, geschlossen für Produktion",
      "Offen für Code, geschlossen für Dokumentation",
    ],
    correct: 0,
    explanation: "OCP: Code sollte offen für Erweiterung (neue Features) sein, aber geschlossen für Änderung (bestehender Code bleibt stabil).",
  },
  {
    question: "Was ist Refactoring?",
    type: "multiple" as const,
    options: [
      "Code verbessern ohne das Verhalten zu ändern",
      "Code komplett neu schreiben",
      "Code löschen",
      "Code kommentieren",
    ],
    correct: 0,
    explanation: "Refactoring = Code verbessern (Struktur, Lesbarkeit) ohne das Verhalten zu ändern. Die Tests müssen weiterhin bestehen.",
  },
  {
    question: "Was besagt das Interface Segregation Principle?",
    type: "multiple" as const,
    options: [
      "Kleine, spezifische Interfaces statt großer, allgemeiner",
      "Alle Klassen müssen ein Interface haben",
      "Interfaces müssen groß sein",
      "Interfaces sind optional",
    ],
    correct: 0,
    explanation: "ISP: Besser viele kleine, spezifische Interfaces als ein großes, allgemeines. Das vermeidet unnötige Abhängigkeiten.",
  },
  {
    question: "Was ist der Unterschied zwischen starkem und losem Coupling?",
    type: "multiple" as const,
    options: [
      "Stark = direkte Abhängigkeit, Los = über Interfaces",
      "Stark = viele Zeilen, Los = wenige Zeilen",
      "Stark = schnell, Los = langsam",
      "Es gibt keinen Unterschied",
    ],
    correct: 0,
    explanation: "Starkes Coupling = direkte Abhängigkeit (new MySQLDatabase()). Loses Coupling = über Interfaces (new Database()). Loses Coupling ist besser.",
  },
];

export const erwProgCategories = [
  {
    id: "erw-prog",
    name: "Erweiterte Programmierung",
    icon: "🔧",
    description: "SOLID, Clean Code, Interfaces, Unit-Tests, Refactoring, Code Smells",
  },
];
